...
void TriggerManager::load(Stream& stream) {
...
void TriggerManager::saveTrigger(Stream& stream, std::shared_ptr<Trigger> t) const
{
...
std::shared_ptr<Trigger> TriggerManager::loadTrigger(Stream& stream)
{
